                    ...
                    <div class="flip-container">
                        <div class="flipper agile-products">
                            ...
                            <div class="back">
                                ...
                                <h6>{{$dish->full_price}}<sup>شيكل</sup></h6>
                             
                                <form action="{{route('add_to_cart')}}" method="post">
                                    <input type="hidden" name="dish_name" value="{{$dish->dish_id}}">
                                       <a href="#" data-toggle="modal" data-target="#myModal1{{$dish->dish_id}}">
                                        More <span class="w3-agile-line"> </span> <i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart </a>
                                </form>
                            </div>
                        </div>
                    </div> 
...
<!-- //modal -->
        ...
        <div class="col-md-3 rsidebar">
            <div style="height:350px; width:220px" class="rsidebar-top">
                <div class="slider-left">
                    <h4>قوائم الطعام</h4>            
                    <div style="padding: 1px;" class="row row1 scroll-pane">
                       
                        @foreach ($categories as $category)
                                
                        <li style="padding: 10px;" ><a style="color:orangered" href="{{route('category_dish',['category_id'=>$category->category_id])}}" >{{$category->category_name}}</a></li>	
